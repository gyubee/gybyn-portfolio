        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 rounded-xl p-6">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-2">
              ...
              <span className="text-sm text-[#94A3B8]">Feb 2024 - Dec 2025</span>
            </div>
            ...
            <div className="text-xs text-gray-500 mb-2">WAM: 73.56 / 100</div>
            <ul className="list-disc ml-5 text-sm text-gray-700 mb-1">
              <li>
                <span className="font-semibold">Major Courses:</span> Enterprise Scale Software Architecture, Model Based Software Engineering, Object-Oriented Programming, Database Management Systems, Design of Networks and Distributed Systems, Data Structures and Algorithms, Cybersecurity Engineering, Web Application Development, Data Engineering, Natural Language Processing, Software Quality Engineering, Project Management in IT
              </li>
              <li>
                <span className="font-semibold">Capstone Project:</span> AI-Focused Marketing Analytics Engine
              </li>
            </ul>
          </div>
